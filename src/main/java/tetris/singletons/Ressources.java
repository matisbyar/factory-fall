...
public class Ressources {
    ...
    public static final Image pieceDefault = new Image(Objects.requireNonNull(TetrisIHM.class.getResourceAsStream("images/default/L.jpg")));
    public static final Image pieceConteneur = new Image(Objects.requireNonNull(TetrisIHM.class.getResourceAsStream("images/conteneur/L.jpg")));
    public static final Image pieceBrique = new Image(Objects.requireNonNull(TetrisIHM.class.getResourceAsStream("images/brique/L.jpg")));
